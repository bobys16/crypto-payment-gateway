...
class TRC20Contract
{
    ...
    */
    ...
    public function approve(string $spender, string $amount): array
    {
        ...
        $transfer = $this->_tron->getTransactionBuilder()
            ->triggerSmartContract(
                ...
                'approve',
                [$this->_tron->address2HexString($spender), $tokenAmount],
                $feeLimitInSun,
                $this->_tron->address['hex']
            );
    ...
    public function transferFrom(string $to, string $amount, string $spender, string $from = null): array
    {
        if($from == null) {
        ...
        $transfer = $this->_tron->getTransactionBuilder()
            ->triggerSmartContract(
                ...
                $this->_tron->address2HexString($this->contractAddress),
                'transferFrom',
                [$this->_tron->address2HexString($spender), $this->_tron->address2HexString($to), $tokenAmount],
                $feeLimitInSun,
