 <?php
$f = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM app WHERE id='".$_COOKIE['app_id']."'"));
 ?>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="transactions-main">
                            <div class="top-items">
                                <h6>List Transactions of <?= $f['name'];?> (Click the transaction to get the detail of it)</h6>
                                 ...
                                 <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                      <?php
                                                      $app_list = array();
                                                      $q_app = mysqli_query($connect,"SELECT * FROM app WHERE user_id = '".$uid."' AND id='".$_COOKIE['app_id']."'");
